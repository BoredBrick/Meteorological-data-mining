...
def compress_and_upload_image(image_path, layer, location, weather_data_id=None):
    ...
    db_operations.insert_image_into_database(image_path, layer, location, weather_data_id)
